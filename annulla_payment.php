...
<body>
	...
	<div align="center">
          <div class="cols" id="scheda1">
                      <div style="" class="col">
                      		<p style="position:absolute; top:150px; width:900px; font-size:18px; font-family:Arial, Helvetica, sans-serif;" ><img src="image/icone/error.png" style="height:25px; width:30px; vertical-align:middle;"/> Hai annullato il pagamento.<br/>
								  Puoi ripetere la registrazione cliccando sul tasto inizia della homepage.<br/>
								  Grazie<br/>
