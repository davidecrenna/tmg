...
<title>Utente inesistente - Top Manager Group</title>
</head>
<body>
<?php 
	...
	<div align="center">
          <div class="cols" id="scheda1">
                      <div style="text-align:center;" class="col">
                      		<p style="position:absolute; top:150px; width:900px; font-size:18px; font-family:Arial, Helvetica, sans-serif;" ><img src="image/icone/mail_delete.png" style="height:25px; width:30px; vertical-align:middle;"/>Utente insesistente su TopManagerGroup.com<br/>
								  Effettua l'iscrizione ed iniziare ad utilizzare subito tutti i servizi offerti da TMG.<br/>
								  Grazie<br/>
