// JavaScript Document﻿// More languages are welcome. Please send your list of country names, error messages, page text and explain text
...
function checkiban(iban) {
	if (checkibancore(iban) == "1") { //alert(altxt[8]);
	return true; } // and prompt result
	else { alert(altxt[9]);
	return false; }}
