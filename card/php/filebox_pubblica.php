            ...
            <div class="cols" id="choose">
                    <div class="col">
                    	...
                    	<div style='width:820px; height:220px; text-align:center;'>
                        	<p style="font-size:15px; font-weight:700; position:absolute; left:10px;">Gestisci DOCUMENTI PUBBLICI</p>
                            <p style="font-size:15px; font-weight:700; position:absolute; left:410px;">Gestisci FOTO GALLERY</p>
                        	<div style='position:absolute; top:40px; left:5px; width:380px; background-color:#787878; text-align:left; height:280px; border:1px #FFFFFF solid; padding-left:10px;' >
                                <div id="public_subfolders" style="overflow-y:auto; overflow-x:hidden; height:264px;">
                               		 <? $card->show_filebox_subfolder("public"); ?>
                                </div>
                                
                            </div>
                            
                            <div style='position:absolute; top:40px; left:405px; width:380px; background-color:#787878; text-align:left; height:280px; border:1px #FFFFFF solid; padding-left:10px;' >
                                <div id="photo_subfolders" style="overflow-y:auto; overflow-x:hidden; height:264px;">
                               		 <? $card->show_filebox_subfolder("photo"); ?>
                                </div>
                                
                            </div>
                            
                            <div style='position:absolute; top:321px; left:5px;  width:390px; text-align:center; height:30px; float:left; border:1px #FFFFFF solid;' >
                                <div id='trigger_overlay_create_public_folder' style="float:left;">
                                    <a target='_self' rel='#overlay_create_public_folder' onclick='Javascript:load_create_public_folder();'>
                            ...
                            <div id="create_public_folder_result"  style="display:none; position:absolute; top:355px; left:25px; width:300px; height:30px; ">
                            </div>
                            
                            <div style='position:absolute; top:321px; left:405px;  width:390px; text-align:center; height:30px; float:left; border:1px #FFFFFF solid;' >
                                <div id='trigger_overlay_create_photo_folder' style="float:left;">
                                	<a target='_self' rel='#overlay_create_photo_folder' onclick='Javascript:load_create_photo_folder();'>
                                    <div class='personal_button green_button' style='width:150px;'>
                                        <span class='text14px' alt='Salva'>CREA ALBUM</span>
                                    </div>
                                    </a>
                                </div>
                        	</div>
                            <div id="create_photo_folder_result"  style="display:none; position:absolute; top:355px; left:430px; width:300px; height:30px; ">
                            </div>
             ...
             <div class="apple_overlay_create_folder" id="overlay_create_photo_folder">
               <div id="actions"></div>
                  <div class="scrollable vertical_create_folder">
                      <div class="items">
                          <div>
                              <div class="item" id='item_create_photo_folder'>
                              </div>
                          </div>
                      </div>
                  </div>
             ...
             <script language="javascript" type="text/javascript"> 
				...
				var overlay_create_photo_folder = $("#trigger_overlay_create_photo_folder a[rel]").overlay({effect: 'apple',top:100});
				...
				function open_overlay_create_photo_folder(){
					overlay_create_photo_folder.overlay().load();
				}
			 </script>
