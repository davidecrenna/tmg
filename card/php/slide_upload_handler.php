...
<?php    
	...
	if($card->is_user_logged()){
		...
		if(!isset($_GET['new_photo'])){
			?>
				<script language="javascript" type="text/javascript">window.parent.Upload_success_slide("<?php echo $targetfilepath ?>",<?php echo $height; ?>,"<?php echo $_GET['index'] ?>");</script>   
			<?php
		}
		else{
			?>
				<script language="javascript" type="text/javascript">window.parent.Upload_success_new_slide("<?php echo $targetfilepath ?>",<?php echo $height; ?>,"<?php echo $_GET['index'] ?>");</script>   
			<?php
		}
